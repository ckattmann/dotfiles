...
Plugin 'terryma/vim-multiple-cursors'  " Ctrl-n for another cursor on *
...
map <leader>p :w<CR> :!~/miniconda3/bin/python %<CR>
autocmd FileType python nmap <F5> :wa<CR>:!~/miniconda3/bin/python %<CR>
" Comment out line with <F4>
